...
<?php
    ...
    $similar_products = $result->Items->Item;
        echo '<div class="alert alert-success">Results found for the query <b>'; echo $query;  echo '</b></div>';
        ...
        foreach($similar_products as $si){
            ...
            echo "<div class='row'>";
                ...
                echo "<div class='text'>";
                    ...
                    echo "<b>Price: </b>" . $si->ItemAttributes->ListPrice->FormattedPrice . "<br><br>";
                    echo "<a class='btn btn-success' href='".$item_url."' target='_blank'>Buy it on Amazon</a>";
                echo "</div>";
            echo "</div>";
        }
        echo '</div>';
